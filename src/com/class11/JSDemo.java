...
public static void main(String[] args) throws InterruptedException {
		...
		js.executeScript("window.scrollBy(0,550)");//scroll down -positive value of pixels
		Thread.sleep(2000);
		
		js.executeScript("window.scrollBy(0, -400)");// scroll up - negative value 
		Thread.sleep(2000);
		
//		WebElement label=driver.findElement(By.xpath("//label[text()='Automation Tool']"));
//		js.executeScript("arguments[0].scrollIntoView(true);", label); // scroll until we'll see the specified element 'label'
		...
		js.executeScript("arguments[0].click();", el);  //click on the specified element 'el' using JVScript Executor
